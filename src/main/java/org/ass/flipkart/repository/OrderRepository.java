...
public class OrderRepository {
	...
	public void saveUpdate(OrderEntity orderEntity) {
	...
	public void saveOrderInfo(OrderDto orderDto) {	
		...
		if(productEntity!=null && orderDto.getQuantity()<=stockEntity.getQuantity()) {
			OrderEntity orderEntity = new OrderEntity(); orderEntity.setProductId(orderDto.getProductId());
			orderEntity.setQuantity (orderDto.getQuantity());
			...
			new ProductRepository().saveStock(stockEntity);
		}
	}
}
